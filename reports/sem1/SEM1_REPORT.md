...
- Status: `PASS`
- Disposition: `RECURSIVE_LADDER_AND_SEMANTIC_SEPARATION_VERIFIED`
...
`C000001` remained immutable and was executed as an actual ancestor during discovery. The miner produced 4 Generation-2 candidates and promoted 3.

- Maximum autonomous concept generation: `2`
- Best Generation-2 concept: `C000005`
- Post-hoc interpretation: Functionally resembles checked transformation, conditional retention, then stateful aggregation as one reusable primitive.
- Generation-2 ablation pass: `true`
- Generation-1 ancestor ablation pass: `true`
...
|---|---:|---:|---:|
| Strict solve rate | 0.800000 | 1.000000 | 0.200000 |
| Search expansions | 218 | 181 | -37 |
...
- Counterfactual probes: `36` (36 passed)
- Valid counterfactual prediction accuracy: `1.000000`
- Invalid-case rejection accuracy: `1.000000`
- Adversarial transfer tests: `8`

## Adaptive Complexity

- Maximum successful reasoning depth: `56`
- Maximum primitive-expanded depth: `17`
- Maximum reasoning width: `28540`
- Maximum live branches: `28540`
- Maximum concepts composed: `2`
- Maximum graph nodes / edges: `17` / `16`
- Peak active concepts: `5`
- Best multi-generation compression ratio: `17.000000`
...
The exact lineage DAG is serialized in `concept_lineage.json`; it contains 17 nodes and 50 edges. Primitive expansion is reconstructable.
