...
// Revision 26 rematerializes every owner and closure synthesis and rebuilds
// every patch variant before consumption. This causally binds typed synthesis
// to the exact source edit instead of trusting a one-to-one boolean label.
pub const SOURCE_REPAIR_ENGINE_REVISION: u64 = 26;
